...
| ⑦ | Tags | **Max 3** label tags with left-pointing triangle and punched hole, centered as a group. y≈250 (baseline). Each tag: triangle tip on left → body (rounded right rx=8) → small circle "hole" near triangle. Fill=accent-500 opacity 0.15, circle fill=bg-mid (palette's darker bg color to simulate punched hole). Text **16px**, `#c8d0dc`, inside body area. Gap ~10px. Path: `M x,y+14 L x+12,y L x+w-8,y Q x+w,y x+w,y+8 L x+w,y+20 Q x+w,y+28 x+w-8,y+28 L x+12,y+28 Z`. Circle: cx=x+19, cy=y+14, r=3. Total width = 12 (triangle) + text_px + 20 (padding) + ~8 (right margin). |

...
| ⑦ | Tags | **Max 3** label tags with left-pointing triangle and punched hole, centered as group. y=244 (top of 28px tall tag). Layout (per tag from x): triangle(x→x+12) → hole at cx=x+18 r=3 → **18px gap zone** → text **16px** `#c8d0dc` at `cx=x+30+text_px/2` → 10px right pad → rx=8 round end. **Total w = 48 + text_px** (triangle=12 + gap=18 + text=text_px + rpad=10 + rx=8). Fill=accent-500 opacity 0.18, hole fill=bg-mid color. Path: `M x,y+14 L x+12,y L x+w-8,y Q x+w,y x+w,y+8 L x+w,y+20 Q x+w,y+28 x+w-8,y+28 L x+12,y+28 Z`. Space between tags = 10px. |

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('description', models.TextField(default='SEO空间是一个Django博客，主要研究网站SEO优化和分享Python编程自学的个人博客网站。本网站后端使用Django框架搭建，前端使用Bootstrap4框架，主要分享博主在Python自学、搜索引擎优化、电子商务运营等方面的学习心得，网站所有文章都是原创。', help_text='用来作为SEO中description,长度参考SEO标准', max_length=240, verbose_name='描述')),
            ],
            options={
                'verbose_name': '分类',
                'ordering': ['name'],
